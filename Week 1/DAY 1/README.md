...
Below are the reference figures for Day 1 (waveform screenshots and the simulation flow diagram) — Fig1 iverilog_simulation_flow, Fig2 GTKWave_waveform_view, Fig3 schematic_symbol_2-to-1_mux.
